package com.yupi.rrapiclientsdk;
...
// 这里给所有的配置加上前缀为"rrapi.client"
@ConfigurationProperties("rrapi.client")
// @Data 注解是一个 Lombok 注解,自动生成了类的getter、setter方法
@Data
// @ComponentScan 注解用于自动扫描组件，使得 Spring 能够自动注册相应的 Bean
@ComponentScan
public class RrApiClientConfig {

    private String accessKey;

    private String secretKey;
    @Bean
    public RrApiClient rrApiClient() {
        return new RrApiClient(accessKey, secretKey);
    }
